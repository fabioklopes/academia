...
urlpatterns = [
    ...
    # Password Reset
    path('password_reset/', auth_views.PasswordResetView.as_view(template_name='academia/password_reset.html', form_class=CustomPasswordResetForm), name='password_reset'),
    ...
    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='academia/password_reset_confirm.html'), name='password_reset_confirm'),
